<p align="center">
  <img src="assets/branding/myrtana-accord-background.jpg" alt="Myrtana Accord" width="100%">
</p>
...
[![Myrtana Accord Ardea battle](media/video/ardea-battle-preview.gif)](media/video/myrtana-accord-ardea-battle.mp4)

Click the animation to open the **12-second gameplay video**.

### Cooperative battle in Ardea

![Myrtana Accord gameplay in Ardea](media/screenshots/03-live-ardea-gameplay.png)

### Cooperative party travelling together

![Cooperative party in Gothic 3](media/screenshots/04-cooperative-party.png)

### One-click installer

![Myrtana Accord installer](media/screenshots/01-installer.png)

### Create or join a campaign

![Myrtana Accord New campaign screen](media/screenshots/02-new-campaign.png)
